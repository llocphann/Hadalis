...
- **Dashboard/Overview:** validate that SongRec no longer leaves stray geometry, Dashboard <-> Applications uses a smooth crossfade as one visual surface, the redesigned System Monitor remains readable at compact sizes, and Available Modules stay horizontal with overflow scrolling instead of vertical stacking.
