...
2. **The maintainer's latest live screenshots reopened several runtime-sensitive items.** Screen Edge persistence/shadow, OSK edge attachment, Sidebar seam stacking, Overview bottom attachment and the Media Equalizer renderer now have source fixes. System Monitor dual-edge composition, Weather compaction and Fan Control settings placement/profile controls remain active source work until addressed and then locally validated.
