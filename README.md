...
- Screen Edge lower corners: the renderer paints top-left/top-right/bottom-left/bottom-right explicitly with one cubic quarter-arc contract, and straight horizontal/vertical shadows now stop before every free corner footprint instead of crossing a separately composited corner overlay. This addresses the light-mode triangular/wedge artifact reported at the two lower corners. Live four-corner comparison with Screen Edge shadow enabled remains.
