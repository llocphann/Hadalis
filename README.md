...
- Screen Edge lower corners: the renderer now paints top-left/top-right/bottom-left/bottom-right explicitly with one cubic quarter-arc contract instead of mirroring Canvas transforms. Live four-corner comparison remains.
