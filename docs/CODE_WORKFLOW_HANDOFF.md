...
Normal/Visual navigation supports `h/j/k/l`, `0`, and `# Code Workflow Phase 0 — completed investigation and online handoff
...
second full IDE. It has three modes: `NORMAL`, `INSERT`, and `VISUAL`.
; edit entry
supports `i/a/I/A/o/O`, while a pointer click places the caret and enters
Insert directly for quick hot fixes; `v` begins character Visual selection; `y` yanks,
