...
| **AdaptivePreviewService** | Capability-aware Overview preview scheduler. Enforces a bounded live-stream budget, semantic dynamic-content hints, and snapshot/live handoff without turning screenshot polling into a video transport. |
