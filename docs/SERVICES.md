...
| **AdaptivePreviewService** | Capability-aware Overview preview scheduler. Keeps Hyprland and Niri live budgets separate, rotates bounded Niri motion probes, prioritizes hover/media/focus signals, and hands off between cached snapshots and compositor-native frames without screenshot polling. |
