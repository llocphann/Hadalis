...
| **LocalMusic** | Left Sidebar MPD frontend. Reads MPD songs/saved playlists/queue, performs MPD-only database/queue operations, and uses MprisController's mpd-mpris player for normal transport. |
