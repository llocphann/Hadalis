...
- `~/.local/state/quickshell/user/generated/app-palette.json` (generated by `switchwall.sh`; consumed by most per-app targets: chrome, editors, gtk-kde, sddm, spicetify, steam, terminals, zed)
