...
كومبوزيتر. هذا اللي يدير النوافذ ويحط البكسلات على الشاشة. iNiR مصمم لـ [Niri](https://github.com/YaLTeR/niri) (كومبوزيتر Wayland تايلنق). iNiR الآن Niri-only؛ وأي ذكر لـ Hyprland هنا هو فقط لتاريخ المشروع وأصل الـ fork.
