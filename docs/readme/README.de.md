...
- **Material ii** — schwebende Leiste, Seitenleisten, Dock; Material ist das einzige globale visuelle Theme
...
- **Globales visuelles Theme** — nur Material; Farbpaletten und lokale Komponentenoptionen bleiben unabhängig
