...
declare -gA IPC_TARGET_DESC=(
  ...
  [panelFamily]="Switch between Material II (\`ii\`, default), Waffle (\`waffle\`) and the Perimeter Liquid Shell, Abyss (\`abyss\`)."
...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["panelFamily:cycle"]="Cycle to next panel family (ii → waffle → abyss → ii)"
  ["panelFamily:set"]="Set specific family (\`\"ii\"\`, \`\"waffle\"\` or \`\"abyss\"\`)"
