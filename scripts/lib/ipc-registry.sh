...
declare -gA IPC_TARGET_DESC=(
  ...
  [notificationCenter]="Family-aware notification history surface. Material opens the bottom-right center; Waffle routes to its native notification center."
...
declare -gA IPC_FUNCTION_DESC=(
  ...
  ["notificationCenter:toggle"]="Open/close the active family's notification center"
  ["notificationCenter:close"]="Close the active family's notification center"
  ["notificationCenter:open"]="Open the active family's notification center"
