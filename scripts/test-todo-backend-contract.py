...
required_facade = [
    ...
    'Config.options?.todo?.obsidian?.sourceMode ?? "markdown-note"',
    ...
    "root.obsidianBackend.migrateInternal(",
    ...
    '"obsidian://open?path=" + encodeURIComponent(root.obsidianBackend.noteFullPath)',
]
